  ...
  return (
    <Card>
      <div className="space-y-6">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <RotateCcw className={cn(
                  "h-5 w-5",
                  settings.enabled ? "text-purple-600" : "text-gray-400"
                )} />
              </button>
              <button
                onClick={toggleAudio}
        ...
        {/* Character Display */}
        <div className="text-center py-12 bg-gradient-to-br from-purple-50 to-white rounded-lg border-2 border-purple-100">
